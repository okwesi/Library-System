...
function getBooks() {
    $.ajax({
        type: 'GET',
        url: `/user/student/get_books/${num_books}/`,
        success: function (response) {
            ...
            setTimeout(() => {
                ...
                <div class="col-sm-6 col-lg-3 mb-4">
                    ...
                    <a href="${url}/user/student/${element.book_id}" class="btn btn-success"  id="update"><i style="font-size:large;" class="bi bi-pen-fill">Read More</i></a>
