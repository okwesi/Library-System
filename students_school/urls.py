...
urlpatterns = [    
        path('school-dashboard/', school_dashboard, name='school-dashboard'),
        path('get_students/', school_get_students, name="get_students"),
        path('school/bookshelf/', school_bookshelf, name="school-bookshelf"),
